...
$data['utmplt'] = basename($_GET['user_template']);
$data['atmplt'] = basename($_GET['admin_template']);
$data['reach_goals'] = $_GET['reach_goals'];
...
$config['email_subject_user'] = str_replace('{REACH_GOALS}', $data['reach_goals'], $config['email_subject_user']);
...
$config['email_subject_admin'] = str_replace('{REACH_GOALS}', $data['reach_goals'], $config['email_subject_admin']);
$config['email_subject_admin'] = str_replace('{SITE_TITLE}', $data['title'], $config['email_subject_admin']);
if(!empty($data['utmplt']) && file_exists($data['utmplt'])) { $config['email_body_user'] = file_get_contents($data['utmplt']); }
...
$config['email_body_user'] = str_replace('{REACH_GOALS}', $data['reach_goals'], $config['email_body_user']);
$config['email_body_user'] = str_replace('{SITE_TITLE}', $data['title'], $config['email_body_user']);
$config['email_body_user'] = str_replace('{ADMIN_SUBJECT}', $config['email_subject_admin'], $config['email_body_user']);
if(!empty($data['atmplt']) && file_exists($data['atmplt'])) { $config['email_body_admin'] = file_get_contents($data['atmplt']); }
...
$config['email_body_admin'] = str_replace('{REACH_GOALS}', $data['reach_goals'], $config['email_body_admin']);
$config['email_body_admin'] = str_replace('{SITE_TITLE}', $data['title'], $config['email_body_admin']);
$config['email_body_admin'] = str_replace('{ADMIN_SUBJECT}', $config['email_subject_admin'], $config['email_body_admin']);
if($f = fopen('formdata.csv', 'a')) {
	...
	$data_subject = iconv("utf8", "windows-1251", str_replace(';', '', $config['email_subject_admin']));
	$data_utm = iconv("utf8", "windows-1251", str_replace(';', '', $data['utm']));
	$data_rg = iconv("utf8", "windows-1251", str_replace(';', '', $data['reach_goals']));
	$data_title = iconv("utf8", "windows-1251", str_replace(';', '', $data['title']));
	fwrite($f, $order_id.';'.date('d.m.y H:i', time()+$config['timezone']*60).';'.$data_name.';'.$data_email.';'.$data_phone.';'.$data_subject.';'.$data_utm.';'.$data_rg.';'.$data_title.PHP_EOL); 
	fclose($f);
}
switch($config['email']) {
	case 1:
...
$config['sms_body_user'] = str_replace('{REACH_GOALS}', $data['reach_goals'], $config['sms_body_user']);
$config['sms_body_user'] = str_replace('{SITE_TITLE}', $data['title'], $config['sms_body_user']);
$config['sms_body_user'] = str_replace('{ADMIN_SUBJECT}', $config['email_subject_admin'], $config['sms_body_user']);
...
$config['sms_body_admin'] = str_replace('{REACH_GOALS}', $data['reach_goals'], $config['sms_body_admin']);
$config['sms_body_admin'] = str_replace('{SITE_TITLE}', $data['title'], $config['sms_body_admin']);
$config['sms_body_admin'] = str_replace('{ADMIN_SUBJECT}', $config['email_subject_admin'], $config['sms_body_admin']);
